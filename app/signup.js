...
const backgrounImage = require("../assets/back2.jpg");

export default function App() {
  const [showPassword, setShowPasswordVisible] = useState(false);
  const [showRPassword, setShowRPasswordVisible] = useState(false);
    ...
    <View style={styles.view1}>
      <ImageBackground source={backgrounImage} style={styles.image}>
        ...
        <View style={styles.view4}>
          ...
          />
          <Pressable onPress={() => setShowRPasswordVisible(!showRPassword)}>
            <MaterialCommunityIcons
        ...
        <Pressable
          ...
          onPress={async () => {
            let data = {
              ...
              re_password: getRePassword,
            };
            let response = await fetch(
              "https://composed-relevant-bird.ngrok-free.app/Talky/SignUp",
              {
                method: "POST",
